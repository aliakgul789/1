...
Cargoex is distributed under the terms of the GNU GPL
Cargoex -Copyright 2018 Cargoex, https://themeansar.com
...
SHORT DESCRIPTION
=================
Cargoex is a powerful bootstrap Wordpress theme for spa or individuals. Cargoex theme which can be used for web design firms or any other transport, Cargoex, woocommerce and any other kind of website purpose. It comes with all features these kind of shop page, blog page, Contact form seven working, custom logo, slides variation, color pallate
...
Transportex WordPress Theme, Copyright 2017 Themeansar
Transportex is distributed under the terms of the GNU General Public License v2 

Cargoex WordPress Theme is the child theme of Transportex, Copyright 2019 themeansar
Cargoex is distributed under the terms of the GNU General Public License v2 

/***** BUNDELED CSS ***/
============================================
This theme uses Underscores
============================================
 * Cargoex is based on Underscores. All the files in the theme package are from Underscores, unless stated otherwise.
...
1. https://pixabay.com/en/port-container-container-terminal-1172267/
